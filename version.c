...
const char * V_SLOCAL_REVISION="101";
const char * V_SREVISION="99a8e89e7af7";
const char * V_STAG="2016.02-101";
const char * V_BRANCH="controller";
const char * V_PROFILE=P_NAME;
const bool V_MODIFIED=true;

/* Version recoverable from the ground */
const uint32_t V_REVISION_0=0x99a8e89e;
const uint16_t V_REVISION_1=0x7af7;
