...
const char * V_SLOCAL_REVISION="89";
const char * V_SREVISION="ce09191d1d10";
const char * V_STAG="2016.02-89";
const char * V_BRANCH="controller";
const char * V_PROFILE=P_NAME;
const bool V_MODIFIED=true;

/* Version recoverable from the ground */
const uint32_t V_REVISION_0=0xce09191d;
const uint16_t V_REVISION_1=0x1d10;
